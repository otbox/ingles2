            ...
            <ol>
                <div class="questao">
                    ...
                    <div>
                        ...
                        <label class = ''for="question-1-answers-A">A) Where </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" />
                        <label for="question-1-answers-B">B) When</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
                        <label for="question-1-answers-C">C)  Why</label>
                    </div>
                ...
                <div class="questao">
                    ...
                    <div>
                        ...
                        <label for="question-2-answers-A">A) Brazilian </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-B" value="B" />
                        <label for="question-2-answers-B">B) Braziliar</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-C" value="C" />
                        <label for="question-2-answers-C">C) Brasilien</label>
                    </div>
                ...
                <div class="questao">
                    ...
                    <div>
                        ...
                        <label for="question-3-answers-A">A) Work</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-B" value="B" />
                        <label for="question-3-answers-B">B) Works</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-C" value="C" />
                        <label for="question-3-answers-C">C) Worked</label>
                    </div>
